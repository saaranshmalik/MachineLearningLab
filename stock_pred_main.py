...
# Define path to data (project root directory)
...
def build_timeseries(mat, y_col_index):
    ...
    y = np.zeros((dim_0,))
    print("dim_0",dim_0)
    for i in tqdm(range(dim_0), desc="Building timeseries"):
...
print(df_ge.shape)
print(df_ge.columns)
# display(df_ge.head(5))  # Commented out - display only works in Jupyter
print(df_ge.head(5))
